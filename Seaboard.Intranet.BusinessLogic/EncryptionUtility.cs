...
namespace Seaboard.Intranet.BusinessLogic
{
    public static class EncryptionUtility
    {
        ...
        // This constant define the standard passPhrase
        private const string defualtPassPhrase = "SgSolutions";

        public static string Encrypt(string plainText)
        {
            return Encrypt(defualtPassPhrase, plainText);
        }
        ...
        {
            return Decrypt(defualtPassPhrase, cipherText);
        }
